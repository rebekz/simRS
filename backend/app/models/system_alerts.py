...
class SystemAlert(Base):
    ...
    severity = Column(
        SQLEnum(AlertSeverity, name="alert_severity", create_constraint=True),
        nullable=False,
        index=True,
    ...
    status = Column(
        SQLEnum(AlertStatus, name="alert_status", create_constraint=True),
        nullable=False,
...
class AlertRule(Base):
    ...
    severity = Column(
        SQLEnum(AlertSeverity, name="alert_rule_severity", create_constraint=True),
        nullable=False,
