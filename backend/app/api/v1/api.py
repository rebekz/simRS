...
# Include patient history endpoints
...
# Include BPJS Eligibility Verification endpoints
api_router.include_router(bpjs_eligibility_verification.router, prefix="/bpjs-eligibility", tags=["bpjs-eligibility"])
...
# Include Appointment Booking Service endpoints
api_router.include_router(appointment_booking.router, prefix="/appointments/booking", tags=["Appointment Booking"])
